...
export interface Session { id: string; date: string; startTime: string; durationMin: number; tutorId: string; tutorName: string; roomId: string; mode: SessionMode; version: number; bookings: Booking[] }
...
export interface SessionInput { date: string; startTime: string; durationMin: 60 | 90; tutorId: string; roomId: string; mode: SessionMode; studentIds: string[]; reason?: string }
export interface EditInput { date: string; startTime: string; durationMin: 60 | 90; tutorId: string; roomId: string; expectedVersion: number; reason: string }
